      ...
      document
        .getElementById("runOpenAnim")
        .addEventListener("click", runOpenStage);
      document
      ...
      document
        .getElementById("run1k")
        .addEventListener("click", () => runSim(1000));
      document
        .getElementById("run5k")
        .addEventListener("click", () => runSim(5000));
      document
